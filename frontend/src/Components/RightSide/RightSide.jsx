                ...
                <table className="custom-table" style={{ width: "90vw" }}>
                    ...
                    </thead>
                    {
                        count && count >= 0 ?
                                ...
                                {data.map((item, index) => (
                                    ...
                                    <React.Fragment key={item.id}>
                                        ...
                                        <tr className={index % 2 === 1 ? 'gray-row' : ''} style={{ cursor: "pointer", height: "30px" }}>
                                            <Link to={`/detail/${item.ItemNo}`} style={{ textDecoration: "none", color: '#000', minWidth: "120px", textAlign: 'center',paddingTop: '10px' , fontWeight: 900 }}><td style={{ color: '#000', border: 'none', textAlign: "bottom", minWidth: "120px" }}><p style={{ marginTop: item.qnty === 0 ? '8px' : '', paddingTop: "8px" }}>{item.SearchDescription}</p>
</td></Link>
                                            <td>{
                            ...
                            </tbody> : <div style={{ width:"150%",display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems:'center', marginLeft: "150%", marginTop: '80%' }}>
                                <h1 style={{ width: "150%" }}>Don’t see what you need? </h1>
                                <h2 ><Link to='https://www.canyoncomponents.com/request-a-quote' style={{ marginLeft: '-45%' }} >Get In Touch!</Link></h2>
                            </div>
                    }
